...
class update_notifymap extends StatefulWidget {
  final DocumentSnapshot ds;

  update_notifymap({this.ds});

  @override
  _update_notifymap createState() => _update_notifymap();
}

class _update_notifymap extends State<update_notifymap> {
